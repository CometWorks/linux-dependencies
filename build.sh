...
#   JOBS                = $(nproc)
#
# Requirements: see docs/building.md. In short: gcc, g++, make, cmake, meson,
# ninja, python3, glslangValidator, pkg-config, curl, tar, git, nasm (or
# yasm), patchelf, readelf, and the .NET SDK.
